...
def test_get_neo4j_config_prioritizes_env_vars(mocker):
    """Tests that Neo4j config prefers environment variables over config file."""
    ...
    # Assert that the values from the environment were used
    assert config.uri == "env_uri"
